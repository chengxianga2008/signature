<div class="eltdf-page-header page-header clearfix">
    ...
    <div class="eltdf-theme-name pull-left" >
        <img src="<?php echo esc_url(readanddigest_get_skin_uri() . '/assets/img/logo.png'); ?>" alt="eltd_logo" class="eltdf-header-logo pull-left"/>
        ...
        <div class="eltdf-top-section-holder-inner">
            ...
            <div class="eltdf-top-buttons-holder">
                <?php if($show_save_btn) { ?>
                    <input type="button" id="eltd_top_save_button" class="btn btn-info btn-sm" value="<?php esc_html_e('Save Changes', 'readanddigest'); ?>"/>
                <?php } ?>
            </div>
