                        ...
                        <div class="eltdf-page-form-section-holder">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <select name="import_example" id="import_example" class="form-control eltdf-form-element dependence">
                                                    <option value="readanddigest">ReadAndDigest</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="eltdf-page-form-section">
                                ...
                                <div class="eltdf-section-content">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="import_load"><span><?php esc_html_e('The import process may take some time. Please be patient.', 'readanddigest') ?> </span><br />
                            ...
                            <div class="eltdf-page-form-section eltdf-import-button-wrapper">
                                ...
                                <div class="alert alert-warning">
                                    <strong><?php esc_html_e('Important notes:', 'readanddigest') ?></strong>
                                    <ul>
                                        <li><?php esc_html_e('Please note that import process will take time needed to download all attachments from demo web site.', 'readanddigest'); ?></li>
                                        <li> <?php esc_html_e('If you plan to use shop, please install WooCommerce before you run import.', 'readanddigest')?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            $(document).on('click', '#import_demo_data', function(e) {
                ...
                if (confirm('Are you sure, you want to import Demo Data now?')) {
                    ...
                    if(import_opt == 'content'){
                        for(var i=1;i<10;i++){
                            var str;
                            if (i < 10) str = 'readanddigest_content_0'+i+'.xml';
                            else str = 'readanddigest_content_'+i+'.xml';
                            jQuery.ajax({
                                type: 'POST',
                                url: ajaxurl,
                                data: {
                                ...
                                success: function(data, textStatus, XMLHttpRequest){
                                    ...
                                    progressbar.val(p);
                                    if (p == 90) {
                                        str = 'readanddigest_content_10.xml';
                                        jQuery.ajax({
                                            type: 'POST',
                                            url: ajaxurl,
                                            data: {
