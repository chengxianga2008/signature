...
add_action('after_setup_theme', 'readanddigest_admin_map_init', 0);

function readanddigest_admin_map_init() {

    do_action('readanddigest_before_options_map');
    ...
    do_action('readanddigest_options_map');

    do_action('readanddigest_after_options_map');
