...
if ( ! function_exists('readanddigest_social_options_map') ) {

	function readanddigest_social_options_map() {
		 ...
		 * Enable Social Share
		 */
		$panel_social_share = readanddigest_add_admin_panel(array(
			'page'  => '_social_page',
		...
		$panel_show_social_share_on = readanddigest_add_admin_panel(array(
			'page'  			=> '_social_page',
		 ...
		 */
		$panel_social_networks = readanddigest_add_admin_panel(array(
			'page'  			=> '_social_page',
		...
		$enable_facebook_share_container = readanddigest_add_admin_container(array(
		...
		$enable_twitter_share_container = readanddigest_add_admin_container(array(
		...
		$enable_google_plus_container = readanddigest_add_admin_container(array(
		...
		$enable_linkedin_container = readanddigest_add_admin_container(array(
		...
		$enable_tumblr_container = readanddigest_add_admin_container(array(
		...
		$enable_pinterest_container = readanddigest_add_admin_container(array(
		...
		$enable_vk_container = readanddigest_add_admin_container(array(
		...
		if(defined('ELATED_TWITTER_FEED_VERSION')) {
            $twitter_panel = readanddigest_add_admin_panel(array(
                'title' => 'Twitter',
                'name'  => 'panel_twitter',
                'page'  => '_social_page'
            ));

            readanddigest_add_admin_twitter_button(array(
                'name'   => 'twitter_button',
        ...
        if(defined('ELATED_INSTAGRAM_FEED_VERSION')) {
            $instagram_panel = readanddigest_add_admin_panel(array(
                'title' => 'Instagram',
                'name'  => 'panel_instagram',
                'page'  => '_social_page'
            ));

            readanddigest_add_admin_instagram_button(array(
	...
	add_action( 'readanddigest_options_map', 'readanddigest_social_options_map', 14);
