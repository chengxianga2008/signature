...
if(!function_exists('readanddigest_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function readanddigest_get_wpml_pages_for_current_page() {
		$wpml_pages_for_current_page = array();

		if(readanddigest_is_wpml_installed()) {
...
if(!function_exists('readanddigest_disable_wpml_css')) {
    function readanddigest_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'readanddigest_disable_wpml_css');
}