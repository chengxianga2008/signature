<div class="eltdf-pt-eight-item eltdf-post-item">
    <?php if ( has_post_thumbnail() ) { ?>
        <div class="eltdf-pt-eight-image-holder">
            ...
            <div class="eltdf-pt-eight-image-inner-holder">
                <a itemprop="url" class="eltdf-pt-eight-slide-link eltdf-image-link" href="<?php echo esc_url(get_permalink()); ?>" target="_self">
                    <?php
    ...
    <div class="eltdf-pt-eight-content-holder">
        <div class="eltdf-pt-eight-title-holder">
            <<?php echo esc_html($title_tag)?> class="eltdf-pt-eight-title">
