...
if(!function_exists('readanddigest_load_modules')) {
    /**
     ...
     */
    function readanddigest_load_modules() {
        foreach(glob(ELATED_FRAMEWORK_ROOT_DIR.'/modules/*/load.php') as $module_load) {
            include_once $module_load;
        }
    }

    add_action('readanddigest_before_options_map', 'readanddigest_load_modules');
}

if(!function_exists('readanddigest_load_shortcode_interface')) {

    function readanddigest_load_shortcode_interface() {

        include_once ELATED_FRAMEWORK_MODULES_ROOT_DIR.'/shortcodes/lib/shortcode-interface.php';

    }

    add_action('readanddigest_before_options_map', 'readanddigest_load_shortcode_interface');

}

if(!function_exists('readanddigest_load_shortcodes')) {
    /**
     ...
     * @see http://php.net/manual/en/function.glob.php
     */
    function readanddigest_load_shortcodes() {
    ...
    add_action('readanddigest_before_options_map', 'readanddigest_load_shortcodes');
}

if(!function_exists('readanddigest_load_list_shortcode')) {

    function readanddigest_load_list_shortcode() {

        include_once ELATED_FRAMEWORK_MODULES_ROOT_DIR.'/blog/shortcodes/lib/shortcode-abstract.php';

    }

    add_action('readanddigest_before_options_map', 'readanddigest_load_list_shortcode');

}

if(!function_exists('readanddigest_load_list_shortcodes')) {
    /**
     ...
     * @see http://php.net/manual/en/function.glob.php
     */
    function readanddigest_load_list_shortcodes() {
    ...
    add_action('readanddigest_before_options_map', 'readanddigest_load_list_shortcodes');
}
...
if(!function_exists('readanddigest_load_widgets')) {
    /**
     * Loades all widgets by going through all folders that are placed directly in widgets folder
     * and loads load.php file in each. Hooks to readanddigest_after_options_map action
     */
    function readanddigest_load_widgets() {
    ...
    add_action('readanddigest_before_options_map', 'readanddigest_load_widgets');
}