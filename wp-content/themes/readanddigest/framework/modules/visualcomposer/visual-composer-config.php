...
if ( ! function_exists('readanddigest_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function readanddigest_configure_visual_composer() {
	...
	add_action('vc_after_init', 'readanddigest_configure_visual_composer');
}

if ( ! function_exists('readanddigest_configure_visual_composer_grid_elemets') ) {
	...
	function readanddigest_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'readanddigest_configure_visual_composer_grid_elemets');
}

if ( ! function_exists('readanddigest_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function readanddigest_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'readanddigest_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Eltdf_Image_With_Hover_Info extends WPBakeryShortCodesContainer {}

}

/*** Row ***/
if ( ! function_exists('readanddigest_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function readanddigest_vc_row_map() {

		$animations = array(
			'No animation' => '',
			'Elements Shows From Left Side' 	=>	'eltdf-element-from-left',
			'Elements Shows From Right Side'	=> 	'eltdf-element-from-right',
			'Elements Shows From Top Side'		=>	'eltdf-element-from-top',
			'Elements Shows From Bottom Side'	=>	'eltdf-element-from-bottom',
			'Elements Shows From Fade'			=>	'eltdf-element-from-fade'
		);
	...
	add_action('vc_after_init', 'readanddigest_vc_row_map');
}