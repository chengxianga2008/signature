...
<?php do_action('readanddigest_before_header_top'); ?>

<div class="eltdf-top-bar">
    <?php if($top_bar_in_grid) : ?>
    <div class="eltdf-grid">
    <?php endif; ?>
		<?php do_action( 'readanddigest_after_header_top_html_open' ); ?>
        <div class="eltdf-vertical-align-containers eltdf-<?php echo esc_attr($column_widths); ?>">
...
<?php do_action('readanddigest_after_header_top'); ?>
