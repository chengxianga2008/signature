<?php
namespace ReadAndDigest\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Elated Custom Font', 'readanddigest'),
				'base' => $this->getBase(),
				'category' => 'by ELATED',
				...
				'params' => array(
					...
					array(
						...
						"value" => readanddigest_get_font_style_array(),
                        'save_always'	=> true,
						"description" => ""
					),
					array(
						...
						"value" => readanddigest_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => readanddigest_get_text_transform_array(),
                        'save_always'	=> true,
						"description" => ""
					),
					array(
	...
	public function render($atts, $content = null) {
		...
		$html = readanddigest_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
