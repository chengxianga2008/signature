<?php
namespace ReadAndDigest\Modules\GoogleMap;
...
class GoogleMap implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Elated Google Map', 'readanddigest'),
				'base' => $this->base,
				'category' => 'by ELATED',
	...
	public function render($atts, $content = null) {
		...
		$html = readanddigest_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
