 ...
 *
 * Class ReadAndDigestWidget
 */
abstract class ReadAndDigestWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
                ...
                switch($param['type']) {
                    ...
                    case 'textfield_html':
                        ...
                        <p>
                            ...
                            <input class="widefat" id="<?php echo esc_attr($this->get_field_id($param['name'])); ?>" name="<?php echo esc_attr($this->get_field_name($param['name'])); ?>" type="text" value="<?php echo esc_attr(${$param['name']}); ?>"/>
                            <?php if(!empty($param['description'])) : ?>
                                <span class="eltdf-field-description"><?php print $param['description']; ?></span>
                            <?php endif; ?>
                        </p>
                        <?php
                        break;    
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'readanddigest'); ?></p>
        <?php }
    }
...
$readanddigest_Framework = ReadAndDigestFramework::get_instance();
$eltdSkinManager = new ReadAndDigestSkinManager();
$readanddigest_Framework->setSkin($eltdSkinManager->getSkin());
