		...
		<div class="<?php echo $which; ?>-bg_color">
			<table class="form-table">
				...
				<tr class="bg_opacity">
					...
					<td>
						<input type="text" readonly value="<?php esc_attr_e( $values['bg_opacity'] ) ?>" name="<?php esc_attr_e( $field_name ); ?>_bg_opacity" id="<?php esc_attr_e( $field_name ); ?>_bg_opacity" class="pum-range-manual popmake-range-manual" step="1" min="0" max="100" data-force-minmax=true />
		...
		<div class="<?php echo $which; ?>-bg_overlay">
			<table class="form-table">
				...
				<tr class="bg_overlay_opacity">
					...
					<td>
						<input type="text" readonly value="<?php esc_attr_e( $values['bg_overlay_opacity'] ) ?>" name="<?php esc_attr_e( $field_name ); ?>_bg_overlay_opacity" id="<?php esc_attr_e( $field_name ); ?>_bg_overlay_opacity" class="pum-range-manual popmake-range-manual popmake-range-manual" step="1" min="0" max="100" data-force-minmax=true />
						<span class="range-value-unit regular-text"><?php _e( '%' ); ?></span>
					</td>
				</tr>
				</tbody>
