...
module.exports = function (grunt) {
  ...
  var moment_str = moment().format('YYYY/MM/');
...
//    },
    ...
    imagemin: {
        dynamic: {
            ...
            files: [{
                expand: true,
                cwd: 'wp-content/uploads/' + moment_str,
                src: ['**/*.{png,jpg,gif}'],
                dest: 'wp-content/uploads/' + moment_str,
            }]
        },
        dynamic1: {
        	options: {
    ...
    image_resize: {
    	dynamic: {
          ...
          files: [{
              expand: true,
              cwd: 'wp-content/uploads/2017/05/',
              src: ['**/*800x600.{png,jpg,gif}'],
              dest: 'wp-content/uploads/2017/05/'
          }]
        }
    },
