  ...
  grunt.initConfig({
    ...
    strip_code: {
      options: {
        blocks: [
          {
            start_block: "<!-- start-strip-code-for-web -->",
            end_block: "<!-- end-strip-code-for-web -->"
          }
        ]
      },
      your_target: {
      ...
      dist: {
        files: [{
          ...
          src: [
            ...
            'styles/fonts/{,*/}*.*',
            'scripts/**/*.html',
            // 'mathjax/**/*', // web version points to mathjax CDN. no need to include local mathjax library
            // 'manifest.json',
            // 'chrome/*'
          ]
        }, {
